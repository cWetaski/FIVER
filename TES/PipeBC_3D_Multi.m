function [M_pipe, RHS_BC_pipe] = PipeBC_3D_Multi(mesh,x_center,y_center,ri,k,h,T_b)
...
%   x_center: x-coord of pipe location
%   y_center: y-coord of pipe location
%   ri:       voxel-radius of pipe
